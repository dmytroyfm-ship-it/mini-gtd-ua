...
// authStore.js.
//
// Пошук — окрема кнопка-лупа праворуч, перед іконкою акаунта
// (.nav__account-slot і так завжди на самому правому краю завдяки
// margin-left: auto — .nav__search без власного авто-відступу на
// десктопі просто йде прямо перед нею; на мобільному .nav__panel
// випадає з потоку (position: fixed), тож .nav__search там отримує
// свій margin-left: auto, інакше лишалась би зліва біля бренду).
