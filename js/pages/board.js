...
// видалених, без list "archive"/"read_watch" — getAllTasks() сама
// їх виключає: «Історія» вже оброблена о 22:30, «Читати/Дивитись» —
// просто матеріали на потім, не робочі задачі), розкладені по
// шести колонках статусів — усі одразу, без спойлера. Перетягування
// картки в іншу колонку одразу оновлює
