...
перечитує список, щоб DOM не розійшовся з базою. На мобільному
(`max-width: 560px`) detailed-рядок переноситься: дедлайн на всю
ширину, тоді «↑↓✎✕» окремим рядком, кнопки завжди видимі (немає
`:hover`).
